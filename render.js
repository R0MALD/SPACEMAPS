...
function renderInfoDialog(array) {
	...
	for (i in array) {
		...
		$('#prominent'+ i).html('<div id="navigator">'+ ((array.length > 1) ? '<a href="javascript:navigate('+ prev +')"><<</a>&nbsp;<a href="javascript:navigate('+ next +')">>></a>' : '' )+'</div>'+
				...
				'<tr><td align="right"><b>Mission:</b><td align="left">' + array[i].name + 
				// '<tr><td align="right"><b>Location:</b><td align="left">' +  array[i].year + 
				 '<tr><td align="right"><b>Location:</b><td align="left">' +  array[i].id + 
				'<tr><td align="right"><b>Emissions:</b><td align="left">'+ array[i].mass + ' kg'+ 
				'<tr><td align="right"><b>State:</b><td align="left"><a href="?cat='+array[i].classVal+'&year='+$.inArray(getYearRange(array[i].year),years)+'">' + $.grep(classArr, function (n){
